...
CREATE INDEX `KNOWN_CHARACTERS_ibfk_1` ON `Final_Project`.`KNOWN_CHARACTERS` (`CHARACTER_AUTHOR` ASC) VISIBLE;
...
CREATE INDEX `ANOMALY_ibfk_1` ON `Final_Project`.`ANOMALY` (`ANOMALY_CHARACTER` ASC) VISIBLE;

CREATE INDEX `ANOMALY_ibfk_2` ON `Final_Project`.`ANOMALY` (`ANOMALY_CONTAIN` ASC) VISIBLE;

CREATE INDEX `ANOMALY_ibfk_3` ON `Final_Project`.`ANOMALY` (`ANOMALY_RISK` ASC) VISIBLE;

CREATE INDEX `ANOMALY_ibfk_4` ON `Final_Project`.`ANOMALY` (`ANOMALY_DANGER` ASC) VISIBLE;

CREATE INDEX `ANOMALY_ibfk_5` ON `Final_Project`.`ANOMALY` (`ANOMALY_SECONDARY` ASC) VISIBLE;

CREATE INDEX `ANOMALY_ibfk_6` ON `Final_Project`.`ANOMALY` (`ANOMALY_CREATE_ID` ASC) VISIBLE;
...
CREATE INDEX `ARTICLE_ibfk_1` ON `Final_Project`.`ARTICLE` (`AUTHOR_ID` ASC) VISIBLE;
...
CREATE INDEX `SCP_ibfk_1` ON `Final_Project`.`SCP` (`ARTICLE_ID` ASC) VISIBLE;
...
CREATE INDEX `ANOMALY_IN_SCP_ibfk_2` ON `Final_Project`.`ANOMALY_IN_SCP` (`ANOMALY_ID` ASC) VISIBLE;
...
CREATE INDEX `CHAR_IN_GOI_ibfk_2` ON `Final_Project`.`CHAR_IN_GOI` (`GOI_NUM` ASC) VISIBLE;
...
CREATE INDEX `GUIDE_ibfk_1` ON `Final_Project`.`GUIDE` (`ARTICLE_ID` ASC) VISIBLE;
...
CREATE INDEX `SITE_ibfk_1` ON `Final_Project`.`SITE` (`ANOMALY_ID` ASC) VISIBLE;
...
CREATE INDEX `TALE_ibfk_1` ON `Final_Project`.`TALE` (`ARTICLE_ID` ASC) VISIBLE;
...
CREATE INDEX `SITES_IN_TALES_ibfk_2` ON `Final_Project`.`SITES_IN_TALES` (`TALE_ID` ASC) VISIBLE;
