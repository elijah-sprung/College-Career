/*
  ...
  Date: 03/22/2021
  Class: CSC1720-03
  Location: /home/students/esprung/csc1720/prog_3/arrayListType.h

  About: Header file for arrayListType.
*/
...
class arrayListType 
{
   ...
   public:
      ...
      */
      ...
      /*
        getAt: Function to find an element at a given location.
        post-condition: Returns the element in the array at the given location.
      */
