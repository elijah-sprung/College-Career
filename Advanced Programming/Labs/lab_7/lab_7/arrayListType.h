/*
  ...
  Date: 02/23/2021
  Class: CSC1720-03
  Location: /home/students/esprung/csc1720/lab_7/arrayListType.h

  About: Header file for the arrayListType class.
*/
...
class arrayListType 
{
   ...
   public:
      ...
      */
      ...
      /*
        insertFirst: Function to insert an integer at the beginning of the list.
        preconditions: An integer must be passed.
        postconditions: The integer will be inserted at the beginning.
      */

      virtual void insertFirst(int insertItem) = 0;

      /*
        findMax: Function to find the largest value in a list.
        preconditions: Nothing passed.
